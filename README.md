...
![Portfolio Preview](public/saminathan-profile.png)
...
- **ML & Deep Learning**: Scikit-Learn, TensorFlow, PyTorch, Pandas, NumPy, OpenCV, NLTK
- **GenAI & Agentic AI**: LangChain, RAG Pipelines, Vector Databases (ChromaDB / Pinecone), FastAPI
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Saminathan6327/my-portfolio-.git
   cd my-portfolio-
   ```
...
- **Email**: [saminathan6327@gmail.com](mailto:saminathan6327@gmail.com)
